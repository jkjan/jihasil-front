...
import {
  type CommentsConfig,
  commentsPlugin,
} from "@/app/(front)/components/editor/plugins/comments-plugin";
import { suggestionPlugin } from "@/app/(front)/components/editor/plugins/suggestion-plugin";
import { Button } from "@/app/(front)/components/plate-ui/button";
import {
  Popover,
  PopoverAnchor,
  PopoverContent,
  PopoverTrigger,
} from "@/app/(front)/components/plate-ui/popover";
import {
  type NodeEntry,
  type Path,
  PathApi,
